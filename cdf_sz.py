...
#     'latency_output_nbub-lf'    :   'dat_tmp/figure_nbub-lf_latency_raw_w_32_ratio_0.1_c_32.dat',
...
file_map = {
    ...
    'latency_output_nbub-lf'    :   'dat_tmp/figure_nbub-lf_latency_raw_w_16_ratio_0.1_c_32.dat',
...
#         plt.show()
#     else:
#         plt.savefig(dir + '/graphs/cdf_Q_ub+nbub-lk+nbub-lf.png', format='png', dpi=1200)
#         plt.savefig(dir + '/graphs/cdf_Q_ub+nbub-lk+nbub-lf.eps', format='eps', dpi=1200)
...
#         plt.show()
#     else:
#         plt.savefig(dir + '/graphs/cdf_UID_ub+nbub-lk+nbub-lf.png', format='png', dpi=1200)
#         plt.savefig(dir + '/graphs/cdf_UID_ub+nbub-lk+nbub-lf.eps', format='eps', dpi=1200)
