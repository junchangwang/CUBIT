...
CUBIT is a scalable bitmap index that provides efficient reads and real-time updates, such that is serves as a drop-in replacement for general secondary indexes for DBMS systems.
