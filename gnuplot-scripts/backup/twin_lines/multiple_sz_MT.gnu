...
plot '../dat/figure_nbub-lf_latency_MT.dat' every 2    using ($2):($1) t "Read" with boxes fs solid 1.0 border rgb "black" lc rgb "black", \
     '../dat/figure_nbub-lf_latency_MT.dat' every 2::1 using ($2):($1) t "Update" with boxes fill pattern 7 border rgb "black" lc rgb "black" axes x1y2