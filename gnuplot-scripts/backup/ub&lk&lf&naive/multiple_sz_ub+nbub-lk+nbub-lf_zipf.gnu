...
set output "../graphs_zipf/multiple_ub+nbub-lk+nbub-lf/Figure_multiple_throughput_core_ub+nbub-lk+nbub-lf.png"
...
set output "../graphs_zipf/multiple_ub+nbub-lk+nbub-lf/Figure_multiple_throughput_core_ub+nbub-lk+nbub-lf.eps"
replot
...
set xrange [0:35]
set terminal png font 'Linux Libertine O,15' size 400, 500
set output "../graphs_zipf/multiple_ub+nbub-lk+nbub-lf/Figure_multiple_latency_core_Query_ub+nbub-lk+nbub-lf.png"
set key font ",18" reverse Left top left
...
set terminal eps font 'Linux Libertine O,17' 
set output "../graphs_zipf/multiple_ub+nbub-lk+nbub-lf/Figure_multiple_latency_core_Query_ub+nbub-lk+nbub-lf.eps"
replot
...
set xrange [0:35]
set terminal png font 'Linux Libertine O,15' size 400, 500
set output "../graphs_zipf/multiple_ub+nbub-lk+nbub-lf/Figure_multiple_latency_core_Update_ub+nbub-lk+nbub-lf.png"
set key font ",18" reverse Left top left
...
set terminal eps font 'Linux Libertine O,17' 
set output "../graphs_zipf/multiple_ub+nbub-lk+nbub-lf/Figure_multiple_latency_core_Update_ub+nbub-lk+nbub-lf.eps"
replot
...
set xrange [0:35]
set terminal png font 'Linux Libertine O,15' size 400, 500
set output "../graphs_zipf/multiple_ub+nbub-lk+nbub-lf/Figure_multiple_latency_core_Insert_ub+nbub-lk+nbub-lf.png"
set key font ",18" reverse Left top left
...
set terminal eps font 'Linux Libertine O,17' 
set output "../graphs_zipf/multiple_ub+nbub-lk+nbub-lf/Figure_multiple_latency_core_Insert_ub+nbub-lk+nbub-lf.eps"
replot
...
set xrange [0:35]
set terminal png font 'Linux Libertine O,15' size 400, 500
set output "../graphs_zipf/multiple_ub+nbub-lk+nbub-lf/Figure_multiple_latency_core_Delete_ub+nbub-lk+nbub-lf.png"
set key font ",18" reverse Left top left
...
set terminal eps font 'Linux Libertine O,17' 
set output "../graphs_zipf/multiple_ub+nbub-lk+nbub-lf/Figure_multiple_latency_core_Delete_ub+nbub-lk+nbub-lf.eps"
replot
...
set xrange [0:35]
set terminal png font 'Linux Libertine O,15' size 400, 500
set output "../graphs_zipf/multiple_ub+nbub-lk+nbub-lf/Figure_multiple_latency_core_Overall_ub+nbub-lk+nbub-lf.png"
set key font ",18" reverse Left top left
...
set terminal eps font 'Linux Libertine O,17' 
set output "../graphs_zipf/multiple_ub+nbub-lk+nbub-lf/Figure_multiple_latency_core_Overall_ub+nbub-lk+nbub-lf.eps"
replot
...
# set yrange [0:]
# set terminal png font 'Linux Libertine O,15' size 400, 500
# set output "../graphs_zipf/multiple_ub+nbub-lk+nbub-lf/Figure_multiple_throughput_ratio_ub+nbub-lk+nbub-lf.png"
...
# 
# set terminal eps font 'Linux Libertine O,17' 
# set output "../graphs_zipf/multiple_ub+nbub-lk+nbub-lf/Figure_multiple_throughput_ratio_ub+nbub-lk+nbub-lf.eps"
# replot
# 
...
# set yrange [0:]
# set terminal png font 'Linux Libertine O,15' size 400, 500
# set output "../graphs_zipf/multiple_ub+nbub-lk+nbub-lf/Figure_multiple_latency_ratio_Query_ub+nbub-lk+nbub-lf.png"
# set key font ",18" reverse Left top left
# 
...
# 
# set terminal eps font 'Linux Libertine O,17' 
# set output "../graphs_zipf/multiple_ub+nbub-lk+nbub-lf/Figure_multiple_latency_ratio_Query_ub+nbub-lk+nbub-lf.eps"
# replot
# 
...
# set yrange [0:]
# set terminal png font 'Linux Libertine O,15' size 400, 500
# set output "../graphs_zipf/multiple_ub+nbub-lk+nbub-lf/Figure_multiple_latency_ratio_Update_ub+nbub-lk+nbub-lf.png"
# set key font ",18" reverse Left top
# 
...
# 
# set terminal eps font 'Linux Libertine O,17' 
# set output "../graphs_zipf/multiple_ub+nbub-lk+nbub-lf/Figure_multiple_latency_ratio_Update_ub+nbub-lk+nbub-lf.eps"
# replot
# 
...
# set yrange [0:]
# set terminal png font 'Linux Libertine O,15' size 400, 500
# set output "../graphs_zipf/multiple_ub+nbub-lk+nbub-lf/Figure_multiple_latency_ratio_Insert_ub+nbub-lk+nbub-lf.png"
# set key font ",18" reverse Left top
# 
...
# 
# set terminal eps font 'Linux Libertine O,17' 
# set output "../graphs_zipf/multiple_ub+nbub-lk+nbub-lf/Figure_multiple_latency_ratio_Insert_ub+nbub-lk+nbub-lf.eps"
# replot
# 
...
# set yrange [0:]
# set terminal png font 'Linux Libertine O,15' size 400, 500
# set output "../graphs_zipf/multiple_ub+nbub-lk+nbub-lf/Figure_multiple_latency_ratio_Delete_ub+nbub-lk+nbub-lf.png"
# set key font ",18" reverse Left top
# 
...
# 
# set terminal eps font 'Linux Libertine O,17' 
# set output "../graphs_zipf/multiple_ub+nbub-lk+nbub-lf/Figure_multiple_latency_ratio_Delete_ub+nbub-lk+nbub-lf.eps"
# replot
# 
...
# set yrange [0:]
# set terminal png font 'Linux Libertine O,15' size 400, 500
# set output "../graphs_zipf/multiple_ub+nbub-lk+nbub-lf/Figure_multiple_latency_ratio_Overall_ub+nbub-lk+nbub-lf.png"
# set key font ",18" reverse Left top
# 
...
# 
# set terminal eps font 'Linux Libertine O,17' 
# set output "../graphs_zipf/multiple_ub+nbub-lk+nbub-lf/Figure_multiple_latency_ratio_Overall_ub+nbub-lk+nbub-lf.eps"
# replot
...
# #set xrange [0:16]
# set terminal png font 'Linux Libertine O,15' size 400, 500
# set output "../graphs_zipf/multiple_ub+nbub-lk+nbub-lf/Figure_multiple_throughput_cardinality_ub+nbub-lk+nbub-lf.png"
# set key font ",18" reverse Left top
...
# set terminal eps font 'Linux Libertine O,17' 
# set output "../graphs_zipf/multiple_ub+nbub-lk+nbub-lf/Figure_multiple_throughput_cardinality_ub+nbub-lk+nbub-lf.eps"
# replot
...
# #set xrange [0:16]
# set terminal png font 'Linux Libertine O,15' size 400, 500
# set output "../graphs_zipf/multiple_ub+nbub-lk+nbub-lf/Figure_multiple_latency_cardinality_Query_ub+nbub-lk+nbub-lf.png"
# set key font ",18" reverse Left top
...
# set terminal eps font 'Linux Libertine O,17' 
# set output "../graphs_zipf/multiple_ub+nbub-lk+nbub-lf/Figure_multiple_latency_cardinality_Query_ub+nbub-lk+nbub-lf.eps"
# replot
...
# #set xrange [0:16]
# set terminal png font 'Linux Libertine O,15' size 400, 500
# set output "../graphs_zipf/multiple_ub+nbub-lk+nbub-lf/Figure_multiple_latency_cardinality_Update_ub+nbub-lk+nbub-lf.png"
# set key font ",18" reverse Left top
...
# set terminal eps font 'Linux Libertine O,17' 
# set output "../graphs_zipf/multiple_ub+nbub-lk+nbub-lf/Figure_multiple_latency_cardinality_Update_ub+nbub-lk+nbub-lf.eps"
# replot
...
# #set xrange [0:16]
# set terminal png font 'Linux Libertine O,15' size 400, 500
# set output "../graphs_zipf/multiple_ub+nbub-lk+nbub-lf/Figure_multiple_latency_cardinality_Insert_ub+nbub-lk+nbub-lf.png"
# set key font ",18" reverse Left top
...
# set terminal eps font 'Linux Libertine O,17' 
# set output "../graphs_zipf/multiple_ub+nbub-lk+nbub-lf/Figure_multiple_latency_cardinality_Insert_ub+nbub-lk+nbub-lf.eps"
# replot
...
# #set xrange [0:16]
# set terminal png font 'Linux Libertine O,15' size 400, 500
# set output "../graphs_zipf/multiple_ub+nbub-lk+nbub-lf/Figure_multiple_latency_cardinality_Delete_ub+nbub-lk+nbub-lf.png"
# set key font ",18" reverse Left top
...
# set terminal eps font 'Linux Libertine O,17' 
# set output "../graphs_zipf/multiple_ub+nbub-lk+nbub-lf/Figure_multiple_latency_cardinality_Delete_ub+nbub-lk+nbub-lf.eps"
# replot
...
# #set xrange [0:16]
# set terminal png font 'Linux Libertine O,15' size 400, 500
# set output "../graphs_zipf/multiple_ub+nbub-lk+nbub-lf/Figure_multiple_latency_cardinality_Overall_ub+nbub-lk+nbub-lf.png"
# set key font ",18" reverse Left top
...
# set terminal eps font 'Linux Libertine O,17' 
# set output "../graphs_zipf/multiple_ub+nbub-lk+nbub-lf/Figure_multiple_latency_cardinality_Overall_ub+nbub-lk+nbub-lf.eps"
# replot
