...
def gen_cmd_nbub(w, a, v, total, ratio, index_path):
...
def gen_cmd_nbub_cardinality(w, a, v, total, ratio, index_path, c, n):
...
def gen_figure_nbub_lk_throughput_core(): 
    ...
    print ('-' * 10)
    core_number = [1, 2, 4, 8, 16, 24, 32]
    f = open('dat_1B/figure_nbub-lk_throughput_core.dat','w')
    for num in core_number:
        cmd = gen_cmd_nbub(num, 'nbub-lk', 'no', 1000, ratio_percentage, index_path)
        print(cmd)
        os.system(cmd)
        ret = throughput_analysis('dat_tmp_1B/figure_nbub-lk_throughput_raw_w_{}_ratio_{}.dat'.format(num, ratio_percentage))
        print(ret)
        print('\n')
        f.write('{} {} \n'.format(num, ret))
    f.close()
...
def gen_figure_nbub_lk_throughput_ratio():
    ...
    print ('-' * 10)
    ratio_number = [0.01, 0.02, 0.05, 0.1, 0.2]
    f = open('dat_1B/figure_nbub-lk_throughput_ratio.dat','w')
    for num in ratio_number:
        cmd = gen_cmd_nbub(16, 'nbub-lk', 'no', 1000, num, index_path)
        print(cmd)
        os.system(cmd)
        ret = throughput_analysis('dat_tmp_1B/figure_nbub-lk_throughput_raw_w_{}_ratio_{}.dat'.format(16, num))
        print(ret)
        print('\n')
        f.write('{} {} \n'.format(num, ret))
    f.close()    
...
def gen_figure_nbub_lk_throughput_cardinality(): 
    ...
    print ('-' * 10)
    cardinality_number = [16, 32, 64, 128, 256]
    f = open('dat_1B/figure_nbub-lk_throughput_cardinality.dat','w')
    for num in cardinality_number:
        index_path = "100M_{}".format(num)
        cmd = gen_cmd_nbub_cardinality(core_for_cardinality, 'nbub-lk', 'no', 1000, ratio_percentage, index_path, num, ONE_HUNDRED_MILLION)
        print(cmd)
        os.system(cmd)
        ret = throughput_analysis('dat_tmp_1B/figure_nbub-lk_throughput_raw_w_{}_ratio_{}_c_{}.dat'.format(core_for_cardinality, ratio_percentage, num))
        print(ret)
        print('\n')
        f.write('{} {} \n'.format(num, ret))
    f.close()
...
def gen_figure_nbub_lk_latency_core(): # latency
    ...
    print ('-' * 10)
    core_number = [1, 2, 4, 8, 16, 24, 32]
    f = open('dat_1B/figure_nbub-lk_latency_core.dat','w')
    for num in core_number:
        cmd = gen_cmd_nbub(num, 'nbub-lk', 'yes', 1000, ratio_percentage, index_path)
        print(cmd)
        os.system(cmd)
        ret = latency_analysis('dat_tmp_1B/figure_nbub-lk_latency_raw_w_{}_ratio_{}.dat'.format(num, ratio_percentage))
        print(ret)
        print('\n')
        for i in range(0,len(ret)):
            f.write('{} {} \n'.format(num, ret[i]))
...
def gen_figure_nbub_lk_latency_ratio():
    ...
    print ('-' * 10)
    ratio_number = [0.01, 0.02, 0.05, 0.1, 0.2]
    f = open('dat_1B/figure_nbub-lk_latency_ratio.dat','w')
    for num in ratio_number:
        cmd = gen_cmd_nbub(16, 'nbub-lk', 'yes', 1000, num, index_path)
        print(cmd)
        os.system(cmd)
        ret = latency_analysis('dat_tmp_1B/figure_nbub-lk_latency_raw_w_{}_ratio_{}.dat'.format(16, num))
        print(ret)
        print('\n')
        for i in range(0,len(ret)):
            f.write('{} {} \n'.format(num, ret[i]))
...
def gen_figure_nbub_lk_latency_cardinality(): 
    ...
    print ('-' * 10)
    cardinality_number = [16, 32, 64, 128, 256]
    f = open('dat_1B/figure_nbub-lk_latency_cardinality.dat','w')
    for num in cardinality_number:
        index_path = "100M_{}".format(num)
        cmd = gen_cmd_nbub_cardinality(core_for_cardinality, 'nbub-lk', 'yes', 1000, ratio_percentage, index_path, num, ONE_HUNDRED_MILLION)
        print(cmd)
        os.system(cmd)
        ret = latency_analysis('dat_tmp_1B/figure_nbub-lk_latency_raw_w_{}_ratio_{}_c_{}.dat'.format(core_for_cardinality, ratio_percentage, num))
        print(ret)
        print('\n')
        for i in range(0,len(ret)):
            f.write('{} {} \n'.format(num, ret[i]))
...
def gen_figure_nbub_lf_throughput_core(): 
    ...
    print ('-' * 10)
    core_number = [1, 2, 4, 8, 16, 24, 32]
    f = open('dat_1B/figure_nbub-lf_throughput_core.dat','w')
    for num in core_number:
        cmd = gen_cmd_nbub(num, 'nbub-lf', 'no', 1000, ratio_percentage, index_path)
        print(cmd)
        os.system(cmd)
        ret = throughput_analysis('dat_tmp_1B/figure_nbub-lf_throughput_raw_w_{}_ratio_{}.dat'.format(num, ratio_percentage))
        print(ret)
        print('\n')
        f.write('{} {} \n'.format(num, ret))
    f.close()
...
def gen_figure_nbub_lf_throughput_ratio():
    ...
    print ('-' * 10)
    ratio_number = [0.01, 0.02, 0.05, 0.1, 0.2]
    f = open('dat_1B/figure_nbub-lf_throughput_ratio.dat','w')
    for num in ratio_number:
        cmd = gen_cmd_nbub(16, 'nbub-lf', 'no', 1000, num, index_path)
        print(cmd)
        os.system(cmd)
        ret = throughput_analysis('dat_tmp_1B/figure_nbub-lf_throughput_raw_w_{}_ratio_{}.dat'.format(16, num))
        print(ret)
        print('\n')
        f.write('{} {} \n'.format(num, ret))
    f.close()    
...
def gen_figure_nbub_lf_throughput_cardinality(): 
    ...
    print ('-' * 10)
    cardinality_number = [16, 32, 64, 128, 256]
    f = open('dat_1B/figure_nbub-lf_throughput_cardinality.dat','w')
    for num in cardinality_number:
        index_path = "100M_{}".format(num)
        cmd = gen_cmd_nbub_cardinality(core_for_cardinality, 'nbub-lf', 'no', 1000, ratio_percentage, index_path, num, ONE_HUNDRED_MILLION)
        print(cmd)
        os.system(cmd)
        ret = throughput_analysis('dat_tmp_1B/figure_nbub-lf_throughput_raw_w_{}_ratio_{}_c_{}.dat'.format(core_for_cardinality, ratio_percentage, num))
        print(ret)
        print('\n')
        f.write('{} {} \n'.format(num, ret))
    f.close()
...
def gen_figure_nbub_lf_latency_core(): # latency
    ...
    print ('-' * 10)
    core_number = [1, 2, 4, 8, 16, 24, 32]
    f = open('dat_1B/figure_nbub-lf_latency_core.dat','w')
    for num in core_number:
        cmd = gen_cmd_nbub(num, 'nbub-lf', 'yes', 1000, ratio_percentage, index_path)
        print(cmd)
        os.system(cmd)
        ret = latency_analysis('dat_tmp_1B/figure_nbub-lf_latency_raw_w_{}_ratio_{}.dat'.format(num, ratio_percentage))
        print(ret)
        print('\n')
        for i in range(0,len(ret)):
            f.write('{} {} \n'.format(num, ret[i]))
...
def gen_figure_nbub_lf_latency_ratio():
    ...
    print ('-' * 10)
    ratio_number = [0.01, 0.02, 0.05, 0.1, 0.2]
    f = open('dat_1B/figure_nbub-lf_latency_ratio.dat','w')
    for num in ratio_number:
        cmd = gen_cmd_nbub(16, 'nbub-lf', 'yes', 1000, num, index_path)
        print(cmd)
        os.system(cmd)
        ret = latency_analysis('dat_tmp_1B/figure_nbub-lf_latency_raw_w_{}_ratio_{}.dat'.format(16, num))
        print(ret)
        print('\n')
        for i in range(0,len(ret)):
            f.write('{} {} \n'.format(num, ret[i]))
...
def gen_figure_nbub_lf_latency_cardinality(): 
    ...
    print ('-' * 10)
    cardinality_number = [16, 32, 64, 128, 256]
    f = open('dat_1B/figure_nbub-lf_latency_cardinality.dat','w')
    for num in cardinality_number:
        index_path = "100M_{}".format(num)
        cmd = gen_cmd_nbub_cardinality(core_for_cardinality, 'nbub-lf', 'yes', 1000, ratio_percentage, index_path, num, ONE_HUNDRED_MILLION)
        print(cmd)
        os.system(cmd)
        ret = latency_analysis('dat_tmp_1B/figure_nbub-lf_latency_raw_w_{}_ratio_{}_c_{}.dat'.format(core_for_cardinality, ratio_percentage, num))
        print(ret)
        print('\n')
        for i in range(0,len(ret)):
            f.write('{} {} \n'.format(num, ret[i]))
