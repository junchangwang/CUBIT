...
file_map = {
    ...
    'latency_output_nbub-lk'    :   'dat_tmp_1B/figure_nbub-lk_latency_raw_w_32_ratio_0.1.dat',
    'latency_output_nbub-lf'    :   'dat_tmp_1B/figure_nbub-lf_latency_raw_w_32_ratio_0.1.dat',
...
def figure_Q_2():   # for ub nbub nbub-lf
    ...
    if fig == 0:
        ...
        plt.savefig(dir + '/graphs_1B/cdf_Q_ub+nbub-lk+nbub-lf.png', format='png', dpi=1200)
        plt.savefig(dir + '/graphs_1B/cdf_Q_ub+nbub-lk+nbub-lf.eps', format='eps', dpi=1200)
...
def figure_UID_2(): # for ub nbub nbub-lf
    ...
    if fig == 0:
        ...
        plt.savefig(dir + '/graphs_1B/cdf_UID_ub+nbub-lk+nbub-lf.png', format='png', dpi=1200)
        plt.savefig(dir + '/graphs_1B/cdf_UID_ub+nbub-lk+nbub-lf.eps', format='eps', dpi=1200)
