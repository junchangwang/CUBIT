...
def gen_figure_cubit_lk_throughput_core(): 
    ...
    for num in core_number:
        ...
        print(cmd)
        os.system(cmd)
        ret = throughput_analysis('dat_tmp/figure_cubit-lk_throughput_raw_w_{}_ratio_{}.dat'.format(num, ratio_percentage))
        print(ret)
        print('\n')
        f.write('{} {} \n'.format(num, ret))
    f.close()
...
def gen_figure_cubit_lk_throughput_cardinality(): 
    ...
    for num in cardinality_number:
        ...
        print(cmd)
        os.system(cmd)
        ret = throughput_analysis('dat_tmp/figure_cubit-lk_throughput_raw_w_{}_ratio_{}_c_{}.dat'.format(core_for_cardinality, ratio_percentage, num))
        print(ret)
        print('\n')
        f.write('{} {} \n'.format(num, ret))
    f.close()
...
def gen_figure_cubit_lk_latency_cardinality(): 
    ...
    for num in cardinality_number:
        ...
        print(cmd)
        os.system(cmd)
        ret = latency_analysis('dat_tmp/figure_cubit-lk_latency_raw_w_{}_ratio_{}_c_{}.dat'.format(core_for_cardinality, ratio_percentage, num))
        print(ret)
        print('\n')
        for i in range(0,len(ret)):
            f.write('{} {} \n'.format(num, ret[i]))
...
def gen_figure_cubit_lf_throughput_core(): 
    ...
    for num in core_number:
        ...
        print(cmd)
        os.system(cmd)
        ret = throughput_analysis('dat_tmp/figure_cubit-lf_throughput_raw_w_{}_ratio_{}.dat'.format(num, ratio_percentage))
        print(ret)
        print('\n')
        f.write('{} {} \n'.format(num, ret))
    f.close()
...
def gen_figure_cubit_lf_throughput_cardinality(): 
    ...
    for num in cardinality_number:
        ...
        print(cmd)
        os.system(cmd)
        ret = throughput_analysis('dat_tmp/figure_cubit-lf_throughput_raw_w_{}_ratio_{}_c_{}.dat'.format(core_for_cardinality, ratio_percentage, num))
        print(ret)
        print('\n')
        f.write('{} {} \n'.format(num, ret))
    f.close()
...
def gen_figure_cubit_lf_latency_cardinality(): 
    ...
    for num in cardinality_number:
        ...
        print(cmd)
        os.system(cmd)
        ret = latency_analysis('dat_tmp/figure_cubit-lf_latency_raw_w_{}_ratio_{}_c_{}.dat'.format(core_for_cardinality, ratio_percentage, num))
        print(ret)
        print('\n')
        for i in range(0,len(ret)):
            f.write('{} {} \n'.format(num, ret[i]))
